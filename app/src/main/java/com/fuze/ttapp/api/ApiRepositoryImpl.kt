...
constructor( private val apiService: ApiService ) : ApiRepository {
    ...
    override fun searchTweet(authorization: String, query: String): Observable<TweetsResponse> = apiService.searchTweet(authorization,query)

    override fun userDetails(authorization: String, screen_name: String): Observable<TwitterProfile> = apiService.userDetails(authorization,screen_name)

    override fun searchUserTweet(authorization: String, screen_name: String): Observable<List<Twit>> = apiService.searchUserTweet(authorization,screen_name)
