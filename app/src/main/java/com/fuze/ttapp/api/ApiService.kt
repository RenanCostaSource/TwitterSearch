...
interface ApiService {
    ...
    fun searchTweet(@Header("Authorization") authorization :String   ,@Query("q")  query : String): Observable<TweetsResponse>

    @GET("1.1/users/show.json")
    fun userDetails(@Header("Authorization") authorization: String,@Query("screen_name") screen_name: String): Observable<TwitterProfile>

    @GET("1.1/statuses/user_timeline.json")
    fun searchUserTweet(@Header("Authorization") authorization :String   ,@Query("screen_name") screen_name: String): Observable<List<Twit>>
